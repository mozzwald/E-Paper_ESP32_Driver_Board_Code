    ...
    public static EPaperDisplay[] getDisplays()
    {
        if (array == null)
        {
            array = new EPaperDisplay[]
            {
                ...
                new EPaperDisplay(122,250,0, "2.13 inch e-Paper V4"),        // 43
                new EPaperDisplay(400,300,0, "4.2 inch e-Paper V2"),         // 44
                new EPaperDisplay(960,680,0, "13.3 inch e-Paper (K)")         // 44
            };
        }
        return array;
    }
